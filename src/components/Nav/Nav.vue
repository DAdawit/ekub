    ...
    <div>
        <v-app-bar app color="primary" dark>
            <div class="d-flex align-center">
                ...
                <v-img alt="Vuetify Logo" class="shrink mr-2" contain src="/logo3.jpg" transition="scale-transition"
                    width="70" />
                </v-avatar>
            </div>
            ...
            <v-chip v-if="timeToDonate" class="mx-3 black--text" color="orange" large to="/app/charityDonation"> 
                <v-icon class="pr-3" color="black">notifications</v-icon>It is time to donate !!!</v-chip>
            <v-avatar color="blue darken-1">
                                    <v-img :src="`https://api.yefikrmead.com/media/${user.user_profile.profile_pic}`" lazy-src="https://image.freepik.com/free-vector/user-icon_126283-435.jpg"></v-img>
            ...
            <v-list>
                ...
                <v-list-group sub-group no-action>
                    <template v-slot:activator>
                        <v-list-item-content>
                            <v-list-item-title>Memebers</v-list-item-title>
                        </v-list-item-content>
                    </template>
                    <v-list-item v-for="(memeber, i) in Memebers" :key="i" router :to="memeber.route">
                ...
                <v-list-item router to="/app/allUsers" v-if="user.level == 0">
                    ...
                    <v-list-item-title>All Memebers</v-list-item-title>
                </v-list-item>
                ...
                <v-list-item router to="/app/activity">
                    <v-list-item-icon>
                        <v-icon>tune</v-icon>
                    </v-list-item-icon>
