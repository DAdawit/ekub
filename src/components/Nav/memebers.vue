            ...
            <template v-for="(item, index) in activeUsers">
                ...
                <v-list-item v-else :key="item.email" >
                  <template  v-if="item.user_profile !== null">
                    <v-list-item-avatar>
                        <v-img :src="item.user_profile.profile_pic" lazy-src="https://image.freepik.com/free-vector/user-icon_126283-435.jpg"></v-img>
                    </v-list-item-avatar>
                  </template>
                     <template  v-if="item.user_profile === null">
                    <v-list-item-avatar>
                        <v-img src="https://image.freepik.com/free-vector/user-icon_126283-435.jpg" lazy-src="https://image.freepik.com/free-vector/user-icon_126283-435.jpg"></v-img>
                    </v-list-item-avatar>
                  </template>
