<template>
  <div>
    ...
    <v-card class="mx-2">
              ...
              <v-card>
                ...
                <v-card-text>
                  <v-row class="d-flex justify-space-around">
                    <v-col>
                      <v-icon color="purple" class="py-2">circle</v-icon>1st
                      Tier<br />
                      <h1 class="py-2">
                        {{ MembersInPercent.first_tier_members }}%
                      </h1>
                      <p>1 / 2 Members</p>
                    </v-col>
                    <v-col>
                      <v-icon color="teal" class="py-2">circle</v-icon>2nd
                      Tier<br />
                      <h1 class="py-2">
                        {{ MembersInPercent.second_tier_members }}%
                      </h1>
                      <p>0 / 4 Members</p>
                    </v-col>
                    <v-col>
                      ...
                      <br />
                      <h1 class="py-2">
                        {{ MembersInPercent.third_tier_members }}%
                      </h1>
                      <p>1 / 8 Members</p>
                    </v-col>
                  </v-row>
            ...
            <v-col class="d-flex justify-center">
              <v-row>
                ...
                <v-col cols="12">
                  ...
                  <h3 class="d-flex justify-center green--text">
                    Gifts Received
                  </h3>
                </v-col>
              </v-row>
      ...
      <v-card>
        <h3 class="pa-5">
          Transactions Record - 10 Most Recent
        </h3>
        <template>
            ...
            <template v-slot:default>
              ...
              <tbody v-if="LatestTransactions">
                <tr v-for="(transaction, index) in LatestTransactions" :key="index">
                  <td>{{ index + 1 }}</td>
                  <td>
                    {{ transaction.from_name }} {{ transaction.from_last_name }}
                  </td>
                  <td>
        ...
        <v-dialog persistent v-model="dialog" width="auto">
          <v-card-text>
            <v-alert prominent type="error">
              <v-row align="center">
                <v-col class="grow">
                  It is time for charity Donation , Please Donate! <small>and you will not see this message</small>
                </v-col>
                <v-col class="shrink">
